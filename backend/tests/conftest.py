...
async def initialize_test_application(test_app: FastAPI) -> FastAPI:  # type: ignore
    async with LifespanManager(test_app):
        yield test_app


@fixture(name="async_client")
async def async_client(initialize_test_application: FastAPI) -> AsyncClient:  # type: ignore
